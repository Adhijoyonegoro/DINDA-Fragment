...
public class LayoutPopupWarning extends AlertDialog.Builder {
    ...
    public LayoutPopupWarning(@NonNull Context context) {
        super(context);
        ...
        Glide.with(context).asGif().load(R.drawable.asset_warning).into(ivTitle);

        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            ivList.setBackground(context.getResources().getDrawable(R.color.color014));
        }

        ivList.setBackgroundDrawable(ContextCompat.getDrawable(context, R.color.color014) );
...
//        alertDialog.setCancelable(false);
        ...
        btnNegativie.setOnClickListener(new View.OnClickListener() {
            @Override
